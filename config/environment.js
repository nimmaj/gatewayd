...
nconf.defaults({
  ...
  'PORT': process.env.OPENSHIFT_NODEJS_PORT || 5000, // Port of http api server
...
nconf.set('DATABASE_HOST', process.env.OPENSHIFT_POSTGRESQL_DB_HOST || dbConfig.host);
nconf.set('DATABASE_PORT', process.env.OPENSHIFT_POSTGRESQL_DB_PORT || dbConfig.port);
